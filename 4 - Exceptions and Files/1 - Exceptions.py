# You have already seen exceptions in previous code. They occur when something
# goes wrong, due to incorrect code or input. When an exception occurs, the program immediately stops.
